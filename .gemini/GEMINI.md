...
* **Component Placement for Bypass Capacitors**: Place bypass capacitors as close as possible to the power/ground pins they filter. Do not route the bypass cap across other signal paths.
